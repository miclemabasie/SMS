...
def edit_student_profile(request, pkid, matricule):
    ...
    if request.method == "POST":
        ...
        print(st_fname, st_lname, st_gender, st_email, st_dob, st_address, st_phone, st_domain)
        ...
        # student.user.username=faker_username,
        ...
        print(student.user, "student .ust alsdkjflakdsjflkj")
        ...
        # student.profile_photo=st_photo,
